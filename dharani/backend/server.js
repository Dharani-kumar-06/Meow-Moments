...
// --- Connect to MongoDB (Dharani DB URL) ---
mongoose.connect(
  'mongodb+srv://dharanikumar006d_db_user:PbtsuNVsu2nNxsNl@cluster0.jxibfnl.mongodb.net/dharanidb?retryWrites=true&w=majority&appName=Cluster0',
  {
    useNewUrlParser: true,
    useUnifiedTopology: true,
  }
)
.then(() => console.log('✅ MongoDB Connected (Dharani DB)'))
...
// --- Routes ---
app.get('/', (req, res) => {
  res.send('🐾 Meow Moments Backend Running');
});
...
if (process.env.NODE_ENV === "production") {
  ...
  app.get(/.*/, (req, res) => {
    res.sendFile(path.join(__dirname, "meow-moments-frontend", "build", "index.html"));
  });
}

// --- Start server ---
app.listen(PORT, () => console.log(`🚀 Meow Moments Server running on port ${PORT}`));